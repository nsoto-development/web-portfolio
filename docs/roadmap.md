...
- **Current focus:** [`static-hub-bootstrap`](epics/static-hub-bootstrap.md) epic — landing M1+M2 (P0 #1–#3)
...
- **Done recently:** nudl init; draft [`design-system/`](../design-system/); project docs (MVP, landing feature); static-hub-bootstrap epic
