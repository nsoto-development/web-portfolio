...
- **Current focus:** landing **M4b** experience accordion Framer, P1 #7 **Recently shipped**, or **M5** WebGL. **M4** Framer Motion **Done**.
...
**Post-v1 polish (landing milestones):** ~~M4 Framer Motion~~ **Done** (focus/contrast sweep deferred); **M4b** experience accordion Framer ([`landing.md`](features/landing.md#m4b--experience-accordion-motion)); M5 WebGL.
